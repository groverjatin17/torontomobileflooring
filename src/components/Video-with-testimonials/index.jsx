                ...
                >
                    ...
                    <div className="info">
                      <div className="img">
                        <div className="img-box">
                          <img src="/img/clients/1.jpg" alt="Client testimonial - successful flooring renovation project" />
                        </div>
                      </div>
                      <div className="cont">
                  ...
                  <div className="item">
                    ...
                    <div className="info">
                      <div className="img">
                        <div className="img-box">
                          <img src="/img/clients/2.jpg" alt="Client testimonial - successful flooring renovation project" />
                        </div>
                      </div>
                      <div className="cont">
                        <div className="author">
                  ...
                  <div className="item">
                    ...
                    <div className="info">
                      <div className="img">
                        <div className="img-box">
                          <img src="/img/clients/3.jpg" alt="Client testimonial - successful flooring renovation project" />
                        </div>
                      </div>
                      <div className="cont">
                        <div className="author">
